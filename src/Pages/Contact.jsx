...
const Contact = () => {
  return (
    <section id="Contact" className="mt-[150px]">
      ...
      <p className="w-[1164px] max-[1180px]:w-4/5 text-center mx-auto lg:text-[20px] md:text-[16px] text-[12px] leading-[30px] text-[#31135E] font-normal mt-[50px] mb-[100px]">
      ...
      <div className="w-4/5 mx-auto rounded-[50px] border border-solid py-[60px] border-[#BE95FF]">
        <form className="mx-auto flex flex-col gap-[40px]">
          <div className="flex flex-wrap gap-[20px] justify-between w-4/5 mx-auto">
            <input
              className="border border-solid border-black border-opacity-25 lg:w-[480.18px] md:w-[380px] w-[260px] rounded-[12px] px-[20px] py-[16px]"
